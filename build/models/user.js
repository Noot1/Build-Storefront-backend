...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not show list of users. Error: ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Could not show user with id: ".concat(id, ". Error: ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hashedPassword, result, row, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, bcrypt_1.default.hashSync(u.password + BCRYPT_PASSWORD, parseInt(SALT_ROUNDS))];
                    case 2:
                    ...
                    case 4:
                        error_3 = _a.sent();
                        throw new Error("Could not create a new user. Error: ".concat(error_3));
    ...
    UserStore.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, deletedUser, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    UserStore.prototype.update = function (id, u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, connection, hashedPassword, result, row, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        sql = "UPDATE users SET firstname = $1 , lastname = $2, password = $3 WHERE id = ".concat(id, " RETURNING *");
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, bcrypt_1.default.hashSync(u.password + BCRYPT_PASSWORD, parseInt(SALT_ROUNDS))];
                    ...
                    case 4:
                        error_5 = _a.sent();
                        throw new Error("Could not update user. Error: ".concat(error_5));
                    case 5: return [2 /*return*/];
                }
            });
        });
